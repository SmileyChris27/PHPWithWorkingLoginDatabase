...
<body class="homebg">
  <div class="site">
    ...
    <main id="content" class="main-content">
        <p><figcaption><a href="ATXMotherboard.php">ATX Motherboard</a></figcaption>A motherboard is printed circuit board containing the principal components of a computer or other device. ATX stands for Advance Technology Extended which is the most popular motherboard today. There are also other form factors such as NLX (New Low Profile) and LPX (Low Profile Extended)One of the best form factor designs that keep a system cool would be called BTX (Balance technology Extended). Buy Now for $229.99.
         </p>
    </main>
    ...
    <aside class="sidebar">
      ...
      <center>
        <form action='index.php' method='GET'>
              ...
              <input style="background-color: black; color: green;" type='submit' name='choice2' value='$229.99' class="BuyProduct" onclick="alert('Motherboard is in the cart please proceed to cart to check out ...')"/>
      </form>
      </center>
    ...
    <center>
      <form action='index.php' method='GET'>
          ...
          <input type='hidden' name='choice' value='products' />
          <input style="background-color: black; color: green;" type='submit' name='choice2' value='$350.00' class="BuyProduct" />
      </center>
    ...
    <center>
      <form action='index.php' method='GET'>
              ...
              <input type='hidden' name='price'  value='350.00' />
              <input type='hidden' name='choice' value='products' />
              <input style="background-color: black; color: green;" type='submit' name='choice2' value='$99.99' class="BuyProduct" />
  </center>
    ...
    <center>
      <form action='index.php' method='GET'>
              ...
              <input type='hidden' name='choice' value='products' />
              <input style="background-color: black; color: green;" type='submit' name='choice2' value='$169.00' class="BuyProduct" />
  </center>
    ...
    <center>
      <form action='index.php' method='GET'>
              ...
              <input type='hidden' name='choice' value='products' />
              <input style="background-color: black; color: green;" type='submit' name='choice2' value='$50.00' class="BuyProduct" />
    </center>
    ...
    <center>
      <form action='index.php' method='GET'>
              ...
              <input type='hidden' name='choice' value='products' />
              <input style="background-color: black; color: green;" type='submit' name='choice2' value='$184.50' class="BuyProduct" />
  </center>
    ...
    <center>
       <form action='index.php' method='GET'>
              ...
              <input type='hidden' name='choice' value='products' />
              <input style="background-color: black; color: green;" type='submit' name='choice2' value='$30.00' class="BuyProduct" />
  </center>
    ...
    <footer class="footer-content">
        <p><span class="bg">@2020 SmileyChris27</span></p>

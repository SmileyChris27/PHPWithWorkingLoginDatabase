...
<?php
      ...
      echo "<a href='index.php?choice=registration'>Sign Up</a>";
  ...
  <div class="site">
    ...
    <aside class="sidebar">
      <center>
        ...
        <input style="background-color: black; color: green;  " type="submit" value="Buy For $600" class="BuyProduct"/>
   ...
   <input style="background-color: black; color: green;  " type="submit" value="Buy For $500" class="BuyProduct"/>
